...
(function () {
	...
	const vm = new Vue({
		...
		methods: {
			...
			calculatePwdScore(pwd) {
				...
				// Якщо варіацій (груп) символів меньше 3 - score не більше PWD_SCORE_GOOD
				if (variationCount < 3)
 ...
 - пароль повинен складатися із щонайменше 6 символів, але може знадобитися більше
 - пароль повинен містити щонайменше три групи символів з чотирьох
 * маленькі літери
 * заглавні літери
 * цифри
 * спеціальні символи`;
